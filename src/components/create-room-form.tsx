...
export function CreateRoomForm() {
    ...
    const createRoomForm = useForm<CreateRoomFormData>({ resolver: zodResolver(createRoomSchema), defaultValues: { name: '', description: '' } })
                        ...
                        <FormField control={createRoomForm.control} name="name" render={({ field }) => {
                            return (
                                <FormItem>
                                    ...
                                    <FormControl><Input {...field} placeholder="Informe o nome da sala" /></FormControl>
                                    <FormMessage />
                                </FormItem>
                            )
                        }}>
                        ...
                        <FormField control={createRoomForm.control} name="description" render={({ field }) => {
                            return (
                                <FormItem>
                                    ...
                                    <FormControl><Textarea {...field} placeholder="Informe uma descrição para a sala" /></FormControl>
                                    <FormMessage />
                                </FormItem>
                            )
                        }}>
